...
public class FolderItem
{
    ...
    /// <summary>
    /// Gets the total number of files within this folder and its subfolders.
    /// </summary>
...
public record ScanOptions
{
    ...
    /// <summary>
    /// Gets the set of glob/wildcard patterns for directories and files to exclude from the scan.
    /// </summary>
...
public class ScanProgress
{
    ...
    {
        get => Volatile.Read(ref _filesScanned);
    ...
    {
        get => Volatile.Read(ref _foldersScanned);
    ...
    {
        get => Interlocked.Read(ref _bytesProcessed);
    ...
    /// <summary>
    /// Creates a thread-safe snapshot of the current progress state.
    /// </summary>
    public ScanProgress CreateSnapshot()
    {
